...
class ArticleSummarizer:
    ...
    def create_ochiai_summary(self, article: Article) -> str:
        ...
        """
        prompt = f"""
次の論文を落合フォーマットで要約してください。落合フォーマットは以下の6つの観点で構成されます：
...
要約は日本語で、各観点について簡潔かつ明確にまとめてください。略語や専門用語は必要に応じて説明を加えてください。
要約は書き言葉で、必ず各セクションを「1. どんなもの？」のように番号付きで明確に区切ってください。
技術や手法のキモは、可能な限り具体的に説明してください。議論はある？では、論文の限界や今後の課題について触れてください。
"""
